...
public class TeapotTests {
	...
	/**
	 * Produce a scene with a  model and render it into a png image
	 */
	@Test
	public void teapot1() {
		...
		/*render*/camera.renderImage();//
		/*render*/camera.printGrid(50, new Color(java.awt.Color.YELLOW));//
		/*render*/camera.writeToImage();
	}
