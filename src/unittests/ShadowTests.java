...
public class ShadowTests {
    ...
    public void sphereTriangleInitial2()
    {
            ...
            scene.lights.add( //
                            new SpotLight(new Color(400, 240, 0), new Point(-85, -85, 130), new Vector(1, 1, -3)) //
                                            .setKl(1E-5).setKq(1.5E-7));
            //Render render = new Render(). //
                            camera.setImageWriter(new ImageWriter("shadowSphereTriangleInitial2", 400, 400)) //
                            //.setCamera(camera) //
                            .setRayTracer(new RayTracerBasic(scene))
            /*render.*/.renderImage()
            /*render.*/.writeToImage();
    ...
    public void sphereTriangleInitial3()
    {
            ...
            scene.lights.add( //
                            new SpotLight(new Color(400, 240, 0), new Point(-73.5, -73.5, 58), new Vector(1, 1, -3)) //
                                            .setKl(1E-5).setKq(1.5E-7));
            //Render render = new Render(). //
                            camera.setImageWriter(new ImageWriter("shadowSphereTriangleInitial3", 400, 400)) //
                            //.setCamera(camera) //
                            .setRayTracer(new RayTracerBasic(scene))
           /* render*/.renderImage()
           /* render*/.writeToImage();
    ...
    public void sphereTriangleInitial4() {
            scene.geometries.add( //
                            new Sphere(new Point(0, 0, -200), 60) //
                                            .setEmission(new Color(java.awt.Color.BLUE)) //
                                            .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)), //
                            new Triangle(new Point(-63, -30, 0), new Point(-30, -63, 0), new Point(-61, -61, -6)) //
                                            .setEmission(new Color(java.awt.Color.BLUE)) //
                                            .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)) //
            );
            scene.lights.add( //
                            new SpotLight(new Color(400, 240, 0), new Point(-100, -100, 200), new Vector(1, 1, -3)) //
                                            .setKl(1E-5).setKq(1.5E-7));
            //Render render = new Render(). //
                            camera.setImageWriter(new ImageWriter("shadowSphereTriangleInitial4", 400, 400)) //
                           // .setCamera(camera) //
                            .setRayTracer(new RayTracerBasic(scene))
           /* render*/.renderImage()
           /* render*/.writeToImage();
    ...
    public void sphereTriangleInitial5() {
            scene.geometries.add( //
                            new Sphere(new Point(0, 0, -200), 60) //
                                            .setEmission(new Color(java.awt.Color.BLUE)) //
                                            .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)), //
                            new Triangle(new Point(-50, -18, 0), new Point(-18, -50, 0), new Point(-48, -48, -6)) //
                                            .setEmission(new Color(java.awt.Color.BLUE)) //
                                            .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)) //
            );
            scene.lights.add( //
                            new SpotLight(new Color(400, 240, 0), new Point(-100, -100, 200), new Vector(1, 1, -3)) //
                                            .setKl(1E-5).setKq(1.5E-7));
            //Render render = new Render(). //
                            camera.setImageWriter(new ImageWriter("shadowSphereTriangleInitial5", 400, 400)) //
                            //.setCamera(camera) //
                            .setRayTracer(new RayTracerBasic(scene))
          /*  render*/.renderImage()
          /*  render*/.writeToImage();
